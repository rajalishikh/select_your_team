...
const Player = ({show,display,display2,chosePlayer,myMoney}) => {
    ...
    return (
        <div className='mt-10'>
...

            {
                ...
                {
                    player.map(item=><Player_details key={item.id} details={item} chosePlayer={chosePlayer} myMoney={myMoney}></Player_details>)
                }
